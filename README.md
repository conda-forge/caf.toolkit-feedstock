...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/caf.toolkit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/caf.toolkit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add caf.toolkit
# for installing globally
pixi global install caf.toolkit
```
...
It is possible to list all of the versions of `caf.toolkit` available on your platform:
...
```
pixi search caf.toolkit --channel conda-forge
```
